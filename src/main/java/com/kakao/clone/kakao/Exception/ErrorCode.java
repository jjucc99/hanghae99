...
public enum ErrorCode {
    ...
    USERNAME_LEGNTH(HttpStatus.CONFLICT, "아이디를 3자 이상 입력하세요."),
    USERNAME_EMAIL(HttpStatus.CONFLICT, "이메일 형식으로 입력 하세요."),
    PASSWORD_CONTAINUSERNAME(HttpStatus.BAD_REQUEST, "비밀번호에 아이디를 포함할 수 없습니다."),
    PASSWORD_LEGNTH(HttpStatus.CONFLICT, "비밀번호를 4자 이상 입력하세요."),
    PASSWORD_PASSWORDCHECK(HttpStatus.BAD_REQUEST, "비밀번호가 일치하지 않습니다."),
    // 400 Bad Request
